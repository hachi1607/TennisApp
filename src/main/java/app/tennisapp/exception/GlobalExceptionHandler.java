...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorMessage> handleMethodArgumentNotValidException(MethodArgumentNotValidException exception) {
        ...
        return ResponseEntity
                .badRequest()
                .body(new ErrorMessage("Validation error", validationErrors));
    }
    ...
    public ResponseEntity<ErrorMessage> handleNoResourceFound(NoResourceFoundException exception) {
        ...
        return ResponseEntity
                .status(HttpStatus.NOT_FOUND)
                .body(new ErrorMessage("Endpoint not found: /" + exception.getResourcePath()));
    }
    ...
    public ResponseEntity<ErrorMessage> handleApiTennisClientError(HttpClientErrorException exception) {
        ...
        return ResponseEntity
                ...
                .body(new ErrorMessage("External API returned an error"));
    }
    ...
    public ResponseEntity<ErrorMessage> handleApiTennisServerError(HttpServerErrorException exception) {
        ...
        return ResponseEntity
                .status(HttpStatus.BAD_GATEWAY)
                .body(new ErrorMessage("External API is currently unavailable"));
    }
    ...
    public ResponseEntity<ErrorMessage> handleApiTennisConnectionError(ResourceAccessException exception) {
        ...
        return ResponseEntity
                ...
                .body(new ErrorMessage("Unable to connect to external api"));
    }
