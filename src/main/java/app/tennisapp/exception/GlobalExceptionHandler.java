...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorMessage> handleMissingParam(MissingServletRequestParameterException exception) {
        log.error("Missing required parameter '{}': {}", exception.getParameterName(), exception.getMessage());
        return ResponseEntity
                .badRequest()
